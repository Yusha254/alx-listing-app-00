...
const Header = () => {
  ...
  return (
    <header className="w-full shadow-md">
      {/* Top Banner */}
      <div className="bg-[#34967c] text-white text-sm py-2 px-4 flex justify-center items-center space-x-2">
      ...
      <div className="grid grid-cols-3 items-center px-6 py-4 bg-white">
        ...
        <div className="flex justify-center">
          ...
          <div className="hidden md:flex items-center border rounded-full px-4 py-2 w-full max-w-3xl divide-x">
            {/* Location */}
            <div className="px-3">
      ...
      {accommodationTypes.map((item, index) => (
        <li
          key={index}
          className="flex flex-col items-center min-w-[80px] cursor-pointer hover:text-[#34967c]"
        >
          {item.icon}
